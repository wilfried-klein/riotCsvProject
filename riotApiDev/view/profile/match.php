...
<td class="info5">
    <div>
     <?php 
     for ($g=0; $g < 5; $g++) {
        echo '<a href="' . $value['summonerNameList'][$g] . '"><div>'; 
        echo '<img src="'. $value['summonerIconList'][$g].'" alt="icone du summoner">' . $value['summonerNameList'][$g];
        echo "</div>";
    }
    ?>
    </div>
    <div>
        <?php
        for ($g=0; $g < 5; $g++) {
            echo '<a href="' . $value['summonerNameList'][$g+5] . '"><div>'; 
            echo $value['summonerNameList'][$g+5] . '<img src="'. $value['summonerIconList'][$g+5] .'" alt="icone du summoner">';
            echo "</div></a>";
        }
        ?>
    </div>
